import 'package:atb_first_project/src/bloc/team_list/team_list_bloc.dart';
import 'package:atb_first_project/src/bloc/teammate_list/teammate_list_bloc.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String initRoute = prefs.containsKey('username') && prefs.containsKey('password')
        ? Routes.profile
        : Routes.login;
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<BookingListBloc>(create: (context) => BookingListBloc(di.sl(), false, null))
      ],
            ...
            return MaterialApp(
              ...
              routes: <String, Widget Function(BuildContext)>{
                ...
                Routes.create_office_1: (BuildContext context) =>
                    const CreateOffice1(),
                // Routes.booking_create_1: (BuildContext context) =>
                //     const CreateBooking1(),
                // Routes.booking_create_2: (BuildContext context) =>
                //     const BookingCreate2Screen(
                //       selectedOffice: 0,
                //     ),
                // Routes.booking_create_3: (BuildContext context) =>
