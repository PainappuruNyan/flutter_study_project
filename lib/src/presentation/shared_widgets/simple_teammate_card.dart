...
class SimpleTeammateCard extends StatelessWidget {
  ...
  const SimpleTeammateCard(
      {super.key, required this.employee, this.onTap, this.onLongTap, this.selectedPlace, required this.isSelected, });
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(
        ...
        side: isSelected ? const BorderSide(color: MyColors.kPrimary, width: 2) : BorderSide.none,
      ),
      elevation: 4,
