...
class FeedbackScreen extends StatelessWidget {
  ...
  final TextEditingController feedbackTitle = TextEditingController();
  final TextEditingController feedbackBody = TextEditingController();
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            MaterialButton(
                              onPressed: () {
                                context.read<FeedbackBloc>().add(FeedbackPost(
